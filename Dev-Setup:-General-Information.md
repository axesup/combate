...
1. Install [MongoDB](https://www.mongodb.org/downloads#production), [Node.js 6](https://nodejs.org/en/download/), npm 3.10.10, [Git](https://desktop.github.com/), and [Python 2.7](https://www.python.org/download/releases/2.7/)
